...
const datos = {
  litologia: [
    { id_elemento: 1, nombre: 'Caliza' },
    { id_elemento: 2, nombre: 'Arcilla' },
  ],
  estructura: [
    { id_elemento: 1, nombre: 'Fractura' },
    { id_elemento: 2, nombre: 'Pliegue' },
  ],
  zona: [
    { id_elemento: 1, nombre: 'Norte' },
    { id_elemento: 2, nombre: 'Sur' },
  ],
...
useEffect(() => {
    if (state.holeid.id_collar<=0) return; // Evita búsquedas vacías
...
return(
    ...
    <div className="p-4 space-y-4 bg-gray-50 h-full">
      {state.holeid.holeid}{" - "}{state.holeid.id_collar}
