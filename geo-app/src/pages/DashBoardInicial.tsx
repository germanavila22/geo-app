...
export default function DashBoardInicial() {
  return (
    <>
     <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-2 mt-3 border-b-2 border-gray-200 pb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-2 mt-3">
